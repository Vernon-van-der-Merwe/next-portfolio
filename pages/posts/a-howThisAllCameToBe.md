---
title: 1. How this all came to be
date: 2023/5/04
...
I have already used a documentation framework called nextra, as you’ve seen in the link I have sent you guys,but that didn’t provide any future value for me personally. It was just two sites I spent 8-16 hours on, but I had nothing toshow for it in the end, unless I send around the link.
...
I want to document my challenges, since besides for a company test every now and then, us engineers are challenged by so many personal challenges as-well, that can provide a potential employer, client or even junior or potential Engineer with valuable insight.
...
After spending a few days with this solution, I dont really have anything to show for it today… Lets build something that can change that.
...
## Step 2: Build the app (the actual test you want)
- Set up the blog / documentation.
- Document this problem
- Document the solution
- Document the tech & architecture
- Build Test and deploy the MVP
    - Authentication
    - Url shortening
    - Value for the end user (MVP)
